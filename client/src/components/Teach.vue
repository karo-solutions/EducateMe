<template>
  <div class="container marketing">
    <h1 class="display-4">Basic Arithmetical Operations</h1>
    <hr>
    ...
    <div class="row">
      <div class="col-md-7">
        <h2 class="display-4 text-center">
          ...
          <br>
          <small>
          <span style="color: #008000;">&nbsp;&nbsp; 15 &nbsp;&nbsp;</span>&nbsp;&nbsp; + &nbsp;&nbsp;<span style="color: #ff00ff;">&nbsp;&nbsp; 5 &nbsp;&nbsp;</span>&nbsp;&nbsp; = &nbsp;&nbsp;<span style="color: #ff0000;">&nbsp;&nbsp;20&nbsp;&nbsp;</span>
          <br>
          <span style="color: #008000;">Summand</span> + <span style="color: #ff00ff;">Summand</span> = <span style="color: #ff0000;">Sum</span>
        </small>
        </h2>
        <p
          class="lead"
    ...
    <div class="row">
      <div class="col-md-7 order-md-2">
        <h2 class="display-4 text-center">
          ...
          <br>
          <small>
          <span style="color: #008000;">&nbsp;&nbsp; 13 &nbsp;&nbsp;</span>&nbsp;&nbsp; - &nbsp;&nbsp;<span style="color: #ff00ff;">&nbsp;&nbsp; 4 &nbsp;&nbsp;</span>&nbsp;&nbsp; = &nbsp;&nbsp;<span style="color: #ff0000;">&nbsp;&nbsp;9&nbsp;&nbsp;</span>
          <br>
          <span style="color: #008000;">Minuend</span> - <span style="color: #ff00ff;">Subtrahend</span> = <span style="color: #ff0000;">Difference</span>
          </small>
        </h2>
        <p
          class="lead"
    ...
    <div class="row">
      <div class="col-md-7 order-md-2">
        <h2 class="display-4 text-center">
          ...
          <br>
          <small>
          <span style="color: #008000;">&nbsp;&nbsp; 6 &nbsp;&nbsp;</span>&nbsp;&nbsp; : &nbsp;&nbsp;<span style="color: #ff00ff;">&nbsp;&nbsp; 2 &nbsp;&nbsp;</span>&nbsp;&nbsp; = &nbsp;&nbsp;<span style="color: #ff0000;">&nbsp;&nbsp; 3 &nbsp;&nbsp;</span>
          <br>
          <span style="color: #008000;">Dividend</span> : <span style="color: #ff00ff;">Divisor</span> = <span style="color: #ff0000;">Quotient</span>
          </small>
        </h2>
        <p
          class="lead"
