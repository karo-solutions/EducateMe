<template>
  <div class="container" v-if="!isLoggedIn">
    ...
    >Want to be the king of math? Register Here or Sign in if you already have an account and start training!</p>
    <p>
  ...
  <div class="container" v-else>
    ...
    <p class="lead text-muted">What do you want to do now?</p>
          ...
          <div class="col-md-4">
            <div class="card mb-4 box-shadow">
              ...
              <div class="card-body">
                <p
                  class="card-text"
                >If you want to learn basic math this is the right section for you.</p>
                <a class="btn btn-block" href="/teach">
                  <button class="btn btn-success btn-lg btn-block">Teach Section</button>
                </a>
              </div>
            </div>
          </div>
